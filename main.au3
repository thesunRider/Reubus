...
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
GUICtrlCreatePic(@ScriptDir &"\gui_components\low_status_layout.jpg",0,728,1920,42)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
GUICtrlCreatePic("",0,728,155,38)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
_loadpic(-1,@ScriptDir &"\gui_components\png\scene_in_focus_layout.png")
GUICtrlCreatePic("",148,728,155,38)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
_loadpic(-1,@ScriptDir &"\gui_components\png\scene_out_focus_layout.png")
GUICtrlCreatePic("",296,728,155,38)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
_loadpic(-1,@ScriptDir &"\gui_components\png\scene_out_focus_layout.png")
...
$LabelScene1=GUICtrlCreateLabel("SCENE1",60,740,70,50)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
GUICtrlSetColor(-1, 0xFFFFFF)
GUICtrlSetFont($LabelScene1,10,20,0,"Times New Roman")
$LabelScene2=GUICtrlCreateLabel("SCENE2",208,740,70,50)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
GUICtrlSetColor(-1, 0xFFFFFF)
GUICtrlSetFont($LabelScene2,10,20,0,"Times New Roman")
$LabelScene3=GUICtrlCreateLabel("SCENE3",356,740,70,50)
GUICtrlSetResizing(-1,$GUI_DOCKAUTO)
GUICtrlSetColor(-1, 0xFFFFFF)
